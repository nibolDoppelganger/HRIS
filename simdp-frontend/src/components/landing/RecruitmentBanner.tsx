...
export const RecruitmentBanner: React.FC = () => {
  ...
  return (
    <section className="py-12 sm:py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="animate-fade-in-up bg-gradient-to-br from-[#0f2557] to-[#1e3a7a] text-white rounded-3xl p-6 sm:p-8 md:p-12 shadow-xl relative overflow-hidden">
        {/* Decorative elements */}
        ...
        <div className="relative max-w-3xl flex flex-col items-start gap-4">
          <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold bg-white/15 text-white border border-white/10 backdrop-blur-md">
          ...
          <p className="text-blue-100/80 text-sm sm:text-base md:text-lg font-light leading-relaxed max-w-xl">
            {rec.info}. Kami membuka kesempatan bagi Anda untuk berkontribusi di divisi: <strong className="font-semibold">{rec.divisi_tersedia.join(', ')}</strong>.
          </p>
          <div className="flex gap-4 mt-4 w-full sm:w-auto">
            <a
              href="/rekrutmen"
              className="px-6 py-3.5 text-sm sm:text-base font-bold text-[#0f2557] bg-white hover:bg-blue-50 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5 w-full sm:w-auto text-center"
            >
              Daftar Sekarang ➔
            </a>
          </div>
