...
interface LoginViewProps {
  onLoginSuccess: (adminName: string, adminRole: string, adminAvatar: string) => void;
}
...
export default function LoginView({ onLoginSuccess }: LoginViewProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate authenticating for premium feel
    setTimeout(() => {
      setIsLoading(false);
      onLoginSuccess("Admin HR", "Administrator", "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=120&auto=format&fit=crop&q=80");
    }, 800);
  };
